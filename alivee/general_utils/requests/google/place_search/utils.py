...
from general_utils.requests.google.place_search.constants import MAX_PLACE_SERACH_RADIUS_IN_METERS
from general_utils.requests.google.place_search.constants import PLACE_SEARCH_REQUEST_PLACE_TYPES
from general_utils.requests.google.place_search.constants import PlaceSearchRankByMethod
from general_utils.requests.google.place_search.constants import PlaceSearchResponseStatus
from general_utils.requests.google.place_search.exceptions import BaseGooglePlaceSearchException
from general_utils.requests.google.place_search.exceptions import ConflictRequestRadiusRankByException
from general_utils.requests.google.place_search.exceptions import ExceedMaximumMainRequestRetryCountException
from general_utils.requests.google.place_search.exceptions import ExceedMaximumNextPageRequestRetryCountException
from general_utils.requests.google.place_search.exceptions import ExceedRequestMaximumRadiusException
from general_utils.requests.google.place_search.exceptions import IncompleteRequestRankByRelatedParamsException
from general_utils.requests.google.place_search.exceptions import InvalidRequestAPIKeyException
from general_utils.requests.google.place_search.exceptions import InvalidRequestPlaceTypeException
from general_utils.requests.google.place_search.exceptions import InvalidResponseStatusException
...
class PlaceSearch(object):
    ...
    def _getPlaceFilterKwargs(self, place_type=None, radius=None, keyword=None, name=None, rank_by=None,
        ...
        if place_type:
            ...
            if place_type not in PLACE_SEARCH_REQUEST_PLACE_TYPES:
        ...
        if radius:
            ...
            if radius > MAX_PLACE_SERACH_RADIUS_IN_METERS:
                raise ExceedRequestMaximumRadiusException(radius=radius, maxRadius=MAX_PLACE_SERACH_RADIUS_IN_METERS)
